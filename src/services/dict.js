...
export async function DictList(params) {
  ...
  return request(`/server/api/mds-dict/selectDictList`, {
    method: 'POST',
    body: params,
  });
}
...
export async function dictAdd(params) {
  return request(
    `/server/api/mds-dict/addDictInfo`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictEdit(params) {
  return request(
    `/server/api/mds-dict/updateDictInfo`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDetails(params) {
  return request(
    `/server/api/mds-dict/viewDetails`,
    {
      method: 'POST',
      body: params,
    },
...
export async function disabledDictInfo(params) {
  return request(
    `/server/api/mds-dict/disabledDictInfo`,
    {
      method: 'POST',
      body: params,
    },
...
export async function enableDictInfo(params) {
  return request(
    `/server/api/mds-dict/enableDictInfo`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDataList(params) {
  return request(`/server/api/mds-dict-data/selectDictDataList`, {
    method: 'POST',
    body: params,
  });
}
export async function dictDataAdd(params) {
  return request(
    `/server/api/mds-dict-data/addDictDataInfo`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDataEdit(params) {
  return request(
    `/server/api/mds-dict-data/updateDictDataInfo`,
    {
      method: 'POST',
      body: params,
    },
...
export async function dictDataDetails(params) {
  return request(`/server/api/mds-dict-data/viewDetails`, {
    method: 'POST',
    body: params,
  });
}
...
export async function disabledDictDataInfo(params) {
  return request(
    `/server/api/mds-dict-data/disabledDictDataInfo`,
    {
      method: 'POST',
      body: params,
    },
...
export async function enableDictDataInfo(params) {
  return request(
    `/server/api/mds-dict-data/enableDictDataInfo`,
    {
      method: 'POST',
      body: params,
    },
