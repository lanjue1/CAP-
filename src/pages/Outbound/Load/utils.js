...
export const codes = {
  page: 'ENDORSELIST',
  accept:'Loadlist_Management_Accept',
  reviewLoadlist:'Loadlist_Management_Review_Loading_List',
  revokeLoadlist:'Loadlist_Management_Revoke_Loading_List',
  deliver:'Loadlist_Management_Deliver',
  cancel:'Loadlist_Management_Cancel_Loading_List',
  invoicelistPrint:'Loadlist_Management_Print_Invoicelist',
  packinglistPrint:'Loadlist_Management_Print_Packinglist',
  loadinglistPrint:'Loadlist_Management_Print_Loadinglist',
  cartonDetailPrint:'Loadlist_Management_Print_cartonDetail',
  detailCancel:'Loadlist_Management_detailCancel',
  detailAddDetail:'Loadlist_Management_detailAddDetail',
};
...
export const allDispatchType = {
  //请求的url
  list: 'Load/selectLoad',
  detail: 'Load/viewLoad',
  operate: 'Load/operateLoad',

  abled: 'Load/abledLoad',
  detailList: 'Load/selectLoadDelivery',
