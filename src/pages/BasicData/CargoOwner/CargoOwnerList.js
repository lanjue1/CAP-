...
@connect(({ CargoOwner, loading, component, i18n }) => ({
    CargoOwner,
    cargoOwnerList: CargoOwner.cargoOwnerList,
...
export default class WarehouseBinList extends Component {
    ...
    render() {
        const { cargoOwnerList, loading, form, language,dictObject } = this.props;
        const {
            expandForm,
            selectedRows,
            _columns,
        ...
        const firstFormItem = (
            <AntdFormItem label={transferLanguage('CargoOwner.field.code', language)} code="code" {...commonParams}>
                <Input />
            </AntdFormItem>
        );
        const secondFormItem = (
            <AntdFormItem label={transferLanguage('CargoOwner.field.fullName', language)} code="fullName" {...commonParams}>
                <Input />
            </AntdFormItem>
        );
        const otherFormItem = [
            [
                <AntdFormItem label={transferLanguage('CargoOwner.field.status', language)} code="status" {...commonParams}>
                   <AdSelect data={dictObject[allDictList.cargoOwnerStatus]} payload={{code:allDictList.cargoOwnerStatus}}/>
