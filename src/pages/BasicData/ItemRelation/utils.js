...
export const codes = {
  page: 'EVENTSPAGE',
  disabled:'Part_Data_Relation_Management_Disable',
  enable:'Part_Data_Relation_Management_Enable',
  add:'Part_Data_Relation_Management_Add',
  delete:'Part_Data_Relation_Management_Delete',
  edit:'Part_Data_Relation_Management_Edit'
};
//通知方式
