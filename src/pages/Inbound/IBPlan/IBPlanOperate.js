...
export default class TypeOperate extends Component {
  ...
  render() {
    ...
    const PODetailsColumns = [
      ...
      {
        // 标题
        title: transferLanguage('IBPlan.field.prNo',language),
        // 数据字段
        dataIndex: 'prNo',
        render: (text, record) => (
      ...
      {
        title: transferLanguage('IBPlan.field.status',language),
        dataIndex: 'status',
        render: text => <span title={text}>{text}</span>,
      },
      {
        title: transferLanguage('IBPlan.field.partNo',language),
        dataIndex: 'partNo',
        render: text => <span title={text}>{text}</span>,
      },
      {
        title: transferLanguage('IBPlan.field.partDesc',language),
        dataIndex: 'partDesc',
        render: text => <AdSelect value={text} onlyRead={true} />,
      },
      {
        title: transferLanguage('IBPlan.field.dn',language),
        dataIndex: 'dn',
        render: text => <AdSelect value={text} onlyRead={true} />,
      },
      {
        title: transferLanguage('IBPlan.field.deliveryDate',language),
        dataIndex: 'deliveryDate',
        render: text => <AdSelect value={text} onlyRead={true} />,
      },
      {
        title: transferLanguage('IBPlan.field.totalGrossWeight',language),
        dataIndex: 'totalGrossWeight',
        render: text => <AdSelect value={text} onlyRead={true} />,
      },
      {
        title: transferLanguage('IBPlan.field.totalNetWeight',language),
        dataIndex: 'totalNetWeight',
        render: text => <AdSelect value={text} onlyRead={true} />,
      },
      {
        title: transferLanguage('IBPlan.field.totalVolume',language),
        dataIndex: 'totalVolume',
        render: text => <AdSelect value={text} onlyRead={true} />,
      },
      {
        title: transferLanguage('IBPlan.field.pieceQty',language),
        dataIndex: 'pieceQty',
        render: text => <AdSelect value={text} onlyRead={true} />,
      },
