...
@connect(({ BuyBilling, loading, component, i18n }) => ({
    BuyBilling,
    receiptList: BuyBilling.receiptList,
...
@Form.create()
export default class BuyBillingList extends Component {
    className = 'BuyBillingList';
    constructor(props) {
        super(props);
        this.state = {
            listCol: {
    ...
    render() {
        ...
        const otherFormItem = [
            ...
            [
                ...
                <AntdFormItem label={transferLanguage('BuyLedger.field.payee', language)} code="payee" {...commonParams}>
                    <Input />
                </AntdFormItem>,
                <AntdFormItem label={transferLanguage('Receipt.field.billingDate', language)} code="createDate" {...commonParams}>
        ...
        const tableButtonsParams = {
            ...
            rightButtons: (
                <Button.Group>
                    <AdButton
                        type="primary"
                        onClick={() => this.print('BUY_BILLING')}
