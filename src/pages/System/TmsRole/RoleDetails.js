...
export default class RoleDetail extends Component {
  ...
  columns = [
    ...
    {
      title:  transferLanguage('RoleDetails.field.beActive', this.props.language),
      dataIndex: 'beActive',
  ...
  render() {
    ...
    const editPageParams = {
      panelValue: [{ key: transferLanguage('RoleDetails.field.info', this.props.language) }, { key: transferLanguage('RoleDetails.field.userDetails', this.props.language) }],
    };
