...
export default class UpdateForm extends Component {
  ...
  render() {
    ...
    const filterColumns = [
      {
        title: transferLanguage('RoleDetails.field.filterName', this.props.language),
    ...
    return (
      <div className={styles.CollapseUpdate}>
        <Modal
          title={transferLanguage('RoleDetails.field.editFilter', this.props.language)}
        ...
        >
          <div className={styles.tableListForm}>
            <Form layout="inline">
              <Row>
                <Col md={24}>
                  <Form.Item label={transferLanguage('RoleDetails.field.filterType', this.props.language)}>
        ...
        <PageHeaderWrapper title={genExtraBasicInfo()}>
          ...
          >
            ...
            <Panel
              header={transferLanguage('RoleDetails.field.setMenu', this.props.language)}
              key="2"
