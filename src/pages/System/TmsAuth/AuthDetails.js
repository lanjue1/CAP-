...
export default class IncidentalDetail extends Component {
  ...
  render() {
    ...
    const editPageParams = {
      panelValue: [{ key: transferLanguage('Common.field.baseInfo', this.props.language) }, { key: transferLanguage('RoleList.field.details', this.props.language) }],
    };

    const formItem = [
      [
        <DetailPage label={transferLanguage('RoleDetails.field.loginName', this.props.language)} value={detail.loginName} />,
        <DetailPage label={transferLanguage('RoleDetails.field.sysName', this.props.language)} value={detail.sysName} />,
      ],
      [
        <DetailPage label={transferLanguage('RoleDetails.field.orgId', this.props.language)} value={detail.orgName} />,
        <DetailPage label={transferLanguage('RoleDetails.field.mobile', this.props.language)} value={detail.mobile} />,
      ],
