            ...
            <Panel header={transferLanguage('Common.field.baseInfo', this.props.language)} key="1" style={customPanelStyle}>
              <div className={styles.tableListForm}>
                <Form layout="inline">
                  <Row gutter={_gutter}>
                    <Col {..._col}>
                      <Form.Item label={transferLanguage('RoleDetails.field.loginName', this.props.language)}>
                    ...
                    <Col {..._col}>
                      <Form.Item label={transferLanguage('RoleDetails.field.sysName', this.props.language)}>
                  ...
                  <Row gutter={_gutter}>
                    <Col {..._col}>
                      <Form.Item label={transferLanguage('RoleDetails.field.orgId', this.props.language)}>
                    ...
                    <Col {..._col}>
                      <Form.Item label={transferLanguage('RoleDetails.field.mobile', this.props.language)}>
